...
API_TOKEN = "8061515205:AAGxh0hfjMtq8zFZMf2rA-RZrznM7tTAWaQ"  # Получаем токен через переменные окружения
ADMIN_ID = "1940474065" # Получаем Telegram ID через переменные окружения
