...
ADMIN_ID = "1314014752"  # Замените на ваш Telegram ID
...
async def set_webhook():
    webhook_url = f"https://api.telegram.org/bot8061515205:AAGxh0hfjMtq8zFZMf2rA-RZrznM7tTAWaQ/setWebhook?url=https://<your-app-name>.vercel.app/webhook"
